...
config :phoenixer_api, PhoenixerApiWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "z0N9JlcBE6iMux3a6vW++8v8dRr56IOywWoZWtrGRy1qkpY9kpK86f+1ImgBOacK",
  render_errors: [view: PhoenixerApiWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: PhoenixerApi.PubSub,
  live_view: [signing_salt: "NgBr/qE5"]
